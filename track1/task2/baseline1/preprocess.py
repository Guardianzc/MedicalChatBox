...
os.makedirs(os.path.join(prefix, 'processed'), exist_ok=True)

write_json(train_set, os.path.join(prefix, 'processed', 'train_set.json'))
write_json(dev_set, os.path.join(prefix, 'processed', 'dev_set.json'))
write_json(test_set, os.path.join(prefix, 'processed', 'test_set.json'))
