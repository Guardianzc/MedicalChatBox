...
class DialogueManager_HRL(object):
    ...
    def next_by_hrl_joint2(self, dialogue_status, lower_action, state, master_action_index, group_id, episode_over, reward):
        ...
        lower_reward = alpha * self.lower_reward_function(state=state, next_state=self.state_tracker.get_state())  # the state of this state and next state by master
