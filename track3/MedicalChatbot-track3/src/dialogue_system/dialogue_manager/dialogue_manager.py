...
class DialogueManager(object):
    ...
    def next(self,save_record,train_mode, greedy_strategy):
        ...
        # return an action and the index in sample space
        # random / DQN best choice
        ...
        if save_record == True:
            self.record_training_sample(
                ...
                # the updated self.state_tracker.state
    ...
    def initialize(self,train_mode=1, epoch_index=None):
        self.trajectory = []
        self.state_tracker.initialize() # initialize the state
        self.inform_wrong_disease_count = 0
        # return the initial state -- user inform state
