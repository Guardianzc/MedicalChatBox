...
parser.add_argument("--warm_start", dest="warm_start",type=int, default=0, help="use rule policy to fill the experience replay buffer at the beginning, 1:True; 0:False")
...
parser.add_argument("--saved_model", dest="saved_model", type=str, default="./../model/dqn/checkpoint04/checkpoint_d10_agt1_dqn1_T22/model_d10_agent1_dqn1_s0_r0_t0_wd0_e1000.ckpt-1000")
...
parser.add_argument("--input_size_dqn", dest="input_size_dqn", type=int, default=max_turn + 1302, help="the input_size of DQN.")
...
parser.add_argument("--reward_for_inform_right_symptom", dest="reward_for_inform_right_symptom", type=float,default=2)
